...
os.system(f"aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://civitai.com/api/download/models/1065370?type=Model&format=SafeTensor&size=pruned&fp=fp16 -d /home/xlab-app-center/ComfyUI/models/checkpoints/ -o WAI_ANI_NSFW_PONYXL.safetensors")
os.system(f"python main.py --cpu --dont-print-server --preview-method auto --enable-cors-header --use-pytorch-cross-attention")
